...
const Input = ({ name, label, placeholder, type, labelId }: InputProps) => {
  return (
    <div className="w-full inline-flex shadow-sm px-3 bg-zinc-900 rounded-md flex-col items-start justify-center gap-0 transition-all outline-none h-14 py-2 hover:bg-zinc-800">
      <label
